    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="title">Insertar Cliente</h5>
            </div>
            <form id="AddCliente" name="AddCliente" method="POST" autocomplete="off" action="index.php?c=Cliente&a=guardar">
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input id="cedula" class="form-control" type="text" name="cedula" placeholder="Documento de Identidad">
                    ...
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El teléfono es requerido">
                        <input id="apellido" class="form-control" type="text" name="apellido" placeholder="Jiemez" required>
                    ...
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="La dirección es requerido">
                        <input id="fechaNacimiento" type="date" class="form-control" name="fechaNacimiento" rows="3" placeholder="1994-05-15" required></input>
