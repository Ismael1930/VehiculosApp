        ...
        <div class="modal-content">
            ...
            <form id="AddCliente" name="AddCliente" method="POST" autocomplete="off" action="index.php?c=Vehiculo&a=actualizar">
                ...
                <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El campo es requerido">
                        <input id="apellido" class="form-control" type="text" value="<?php echo ''?>" name="marca" placeholder="Jiemez" required>
                        <label for="apellido"><i class="fas fa-phone"></i> Marca <span class="text-danger fw-bold">*</span> </label>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El campo es requerido">
                        <input id="fechaNacimiento" type="text" class="form-control" value="<?php echo ''?>" name="modelo" rows="3" placeholder="1994-05-15" required></input>
                        <label for="direccion"><i class="fas fa-home"></i> Modelo <span class="text-danger fw-bold">*</span> </label>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El campo es requerido">
                        <input id="fechaNacimiento" type="date" class="form-control" value="<?php echo $vehiculo['Date']?>" name="date" rows="3" placeholder="1994-05-15" required></input>
                        <label for="direccion"><i class="fas fa-home"></i> Año <span class="text-danger fw-bold">*</span> </label>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El campo es requerido">
                        <input id="fechaNacimiento" type="text" class="form-control" value="<?php echo $vehiculo['Color']?>" name="color" rows="3" placeholder="1994-05-15" required></input>
                        <label for="direccion"><i class="fas fa-home"></i> Color <span class="text-danger fw-bold">*</span> </label>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El campo es requerido">
                        <input id="fechaNacimiento" type="text" class="form-control" value="<?php echo ''?>" name="cliente" rows="3" placeholder="1994-05-15" required></input>
